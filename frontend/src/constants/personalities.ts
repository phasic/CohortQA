/**
 * Personality templates that get injected into prompts and TTS
 */
...
export interface PersonalityTemplate {
  name: string;
  description: string;
  plannerPrefix: string; // Gets prepended to planner prompts
  ttsPrefix: string; // Gets prepended to TTS prompts
...
export const PERSONALITIES: Record<Personality, PersonalityTemplate> = {
  playful: {
    name: 'Playful',
    description: 'Fun, lighthearted, and curious',
  ...
  sarcastic: {
    name: 'Sarcastic',
    description: 'Dry wit, ironic, and slightly mocking',
  ...
  annoyed: {
    name: 'Annoyed',
    description: 'Frustrated, impatient, and slightly grumpy',
  ...
  excited: {
    name: 'Excited',
    description: 'Energetic, enthusiastic, and upbeat',
  ...
  curious: {
    name: 'Curious',
    description: 'Inquisitive, questioning, and exploratory',
  ...
  skeptical: {
    name: 'Skeptical',
    description: 'Doubtful, questioning, and cautious',
  ...
  enthusiastic: {
    name: 'Enthusiastic',
    description: 'Passionate, eager, and optimistic',
